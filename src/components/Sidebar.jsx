  ...
  return (
    <>
      ...
      <aside
        className={`${
          isOpen ? "block" : "hidden"
        } lg:block w-1/5 bg-[#2A3F54] text-white h-screen lg:relative lg:translate-x-0 fixed top-0 left-0 z-50 lg:h-screen transform transition-transform duration-300 ease-in-out`}
      >
        ...
        <nav className="flex pl-12 pt-10">
          <ul className="flex flex-col gap-8">
            ...
            <li>
              <Link to={"/table"} className="flex items-center gap-2">
                <ActiveSidebar link={"/table-barang"}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
            ...
            <li>
              <Link to={"/all-barang"} className="flex items-center gap-2">
                <ActiveSidebar link={"/semua-barang"}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
...
const ActiveSidebar = ({ link, children }) => {
  const location = useLocation();
  return (
    <Link
      to={link}
